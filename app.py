...
app = Flask(__name__)
app.config.update(SECRET_KEY='eg_optimal_final_v26_full', SECURITY_PASSWORD_SALT='eg_salt_987')
...
def register():
    if request.method == 'POST':
        ...
        except: flash("Mail hatası oluştu.")
...
# --- VERİ İŞLEMLERİ (SİLME, EKLEME, EXCEL) ---
...
def delete_entry(id):
    ...
    if e: db.session.delete(e); db.session.commit(); flash("Belge silindi.")
