...
cloudinary.config(
    cloud_name='dh2pefkko',          # Sonu 'o' ile bitecek (Panelde teyit ettik)
    api_key='414697559795627',       # Moderation API Key'in
    api_secret='0q2xexoiKr25EeuI6CmFF8CXf2c' # Word'e yapıştırdığın tam şifre
)
